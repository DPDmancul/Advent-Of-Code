...
parse = fst . fromJust . runParser (many parseMulWithNoise)
  where
    parseMulWithNoise = parseMul <|> parseAnyChar *> parseMulWithNoise
    parseMul = parseString "mul(" *> parseTuple <* parseString ")"
